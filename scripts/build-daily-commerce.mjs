...
const log = {
  ...
  sourceRows: catalog.importReport?.sourceRows || 0,
  skippedRows: catalog.importReport?.skippedRows || 0,
  productsImported: changes.added.length,
  productsUpdated: changes.changed.length,
  duplicatesSkipped: catalog.importReport?.duplicateRows?.length || catalog.importReport?.duplicatesSkipped?.length || 0,
  invalidRows: catalog.importReport?.invalidRows || [],
  inactiveRows: catalog.importReport?.inactiveRows || [],
  missingRequiredFields: catalog.importReport?.missingRequiredFields || {},
